...
from entregadelosalpes.modulos.orden.infraestructura.schema.v1.comandos import ComandoCrearOrden, ComandoCrearOrdenPayload
from entregadelosalpes.seedwork.infraestructura import utils

from entregadelosalpes.modulos.orden.infraestructura.mapeadores import MapadeadorEventosOrden
...
class Despachador:
    ...
    def publicar_evento(self, evento, topico):
        print("----EVENTeeeOOOOOO------",evento)
        evento = self.mapper.entidad_a_dto(evento)
        print("----EVENTOOOOOO------",evento)
